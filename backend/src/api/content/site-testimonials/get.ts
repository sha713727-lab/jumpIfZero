import { listQuerySchema, siteTestimonialsListResponseSchema } from "@jumpifzero/contracts";
...
export const schema = {
  ...
  output: siteTestimonialsListResponseSchema,
};
...
export default async function handle(input: {
  ...
  return testimonialsService.listSiteTestimonials(
    input.query,
