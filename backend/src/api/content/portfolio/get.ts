import { listQuerySchema, portfolioListResponseSchema } from "@jumpifzero/contracts";
...
export const schema = {
  ...
  output: portfolioListResponseSchema,
};
...
export default async function handle(input: {
  ...
  return portfolioService.listPortfolioItems(
    input.query,
