-- Dev seeds only. Site section visuals. Never load in production.
...
FROM (VALUES
  ('about_gallery', '/images/hero-office.png', 'JZ Enterprises work', 10),
  ('about_gallery', '/images/hero-team.png', 'JZ Enterprises work', 20),
  ('about_gallery', '/images/hero-visual.png', 'JZ Enterprises work', 30),
  ('about_gallery', '/images/welcome-hero.png', 'JZ Enterprises work', 40),
  ('about_gallery', '/images/services/website.jpg', 'JZ Enterprises work', 50),
  ('about_gallery', '/images/services/software.jpg', 'JZ Enterprises work', 60),
  ('about_gallery', '/images/services/app.jpg', 'JZ Enterprises work', 70),
  ('about_gallery', '/images/services/seo.jpg', 'JZ Enterprises work', 80),
  ('about_gallery', '/images/services/smm.jpg', 'JZ Enterprises work', 90),
  ('about_gallery', '/images/services/design.jpg', 'JZ Enterprises work', 100),
...
FROM (VALUES
  ...
  (
    ...
    'JZ Enterprises team collaboration',
    30
  )
