-- Production CMS bootstrap. Idempotent. No CRM / synthetic freight PII.
...
FROM (VALUES
  ('JumpIfZero Owner', 'Founder', 'Leads product and delivery for JumpIfZero.', '/images/services/design.jpg', 10),
  ('Delivery Lead', 'Delivery Lead', 'Owns client delivery and technical execution.', '/images/services/software.jpg', 20)
