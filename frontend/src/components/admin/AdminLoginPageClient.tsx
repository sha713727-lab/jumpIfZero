...
export function AdminLoginPageClient() {
  ...
  const [values, setValues] = useState<AdminLoginFormValues>(EMPTY_VALUES);
  ...
  const setField = <K extends keyof AdminLoginFormValues>(
    key: K,
      ...
      >
        <div className="w-full max-w-[22rem]">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <button
                  ...
                  aria-label={
                    showPassword
                      ? adminLoginCopy.hidePassword
                      : adminLoginCopy.showPassword
                  }
                  disabled={disabled}
          ...
          >
            ...
            {status === "google"
              ? adminLoginCopy.googleSubmitting
              : adminLoginCopy.google}
          </button>
