      ...
      <div className="relative mx-auto w-full max-w-[1360px] px-5 pt-16 pb-8 md:px-8 md:pt-20 md:pb-10 lg:px-10">
        <div className="grid gap-12 md:grid-cols-[1fr_auto_1fr] md:items-start md:gap-10">
          ...
          <div className="md:justify-self-end md:text-right">
            <Link
              href="/contact"
              className="group inline-flex items-center gap-2 text-[0.92rem] font-medium tracking-[-0.01em] text-cream transition-colors hover:text-logo-gradient focus-visible:ring-2 focus-visible:ring-cream/50 focus-visible:outline-none"
            >
              Contact
