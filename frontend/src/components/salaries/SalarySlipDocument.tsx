...
const sectionLabelClass =
  "text-[0.78rem] font-extrabold tracking-[0.12em] text-[#5c3d18] uppercase";
...
export function SalarySlipDocument({ slip }: SalarySlipDocumentProps) {
  ...
  return (
    ...
    >
      <div className="relative z-10 flex h-full flex-col px-[5.5%] pt-[4%] pb-[3.4%]">
          ...
          <div>
            ...
            <div className="mt-3 flex items-center gap-3.5">
              <Image
                ...
                priority
                quality={100}
                className="h-14 w-14 object-contain md:h-[3.75rem] md:w-[3.75rem]"
              />
              <div>
                <h1 className="text-[1.75rem] font-extrabold tracking-[-0.02em] md:text-[1.95rem]">
                  {site.name}
                </h1>
                <p className="mt-1 text-[0.88rem] font-semibold tracking-[0.04em] text-black/45 uppercase">
                  {site.tagline}
                </p>
              </div>
            </div>
          </div>
          <div className="text-right text-[0.95rem] font-medium text-black/55">
        ...
        <div className="mt-6 grid shrink-0 gap-3.5 border-y border-black/10 py-5 text-[1rem] sm:grid-cols-2">
          <p>
        ...
        <div className="mt-auto grid shrink-0 gap-12 pt-14 sm:grid-cols-2">
          ...
          <div>
            <p className="text-[0.95rem] font-semibold">Authorised Signatory:</p>
            <div className="mt-16 border-b border-black/40" />
          </div>
        </div>
